...
EXP_NAME = 'randomized_envs_debug'
...
# Original author path pointed at a machine-local processed image that is not in
# the repo; fall back to the repo's racetrack mask so this runs on the server.
env_config_self_segmented["image_string"] = 'binary_images/default_mask_racetrack_segmented.png'
